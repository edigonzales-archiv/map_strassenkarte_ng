...
<qgis version="2.7.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{40a8cbf1-d989-4b29-8a0e-175e564ea89b}">
      <rule checkstate="0" filter="&quot;other_tags&quot; LIKE '%&quot;rail&quot;%' or &quot;other_tags&quot; LIKE '%&quot;railway&quot;%'" key="{3d607fbb-1aae-4151-b398-ac060879a9e5}" symbol="0" label="rails"/>
      <rule filter="&quot;type&quot; = 'motorway' " key="{78096e54-e86c-4105-88a3-1e00115dc98d}" label="motorway">
      ...
      <rule filter="&quot;type&quot; IN ( 'motorway_link','trunk','primary')" key="{14998238-76cd-4c84-8f91-c6821c4119c5}" label="trunk &amp; primary">
      ...
      <rule filter="&quot;type&quot; IN ( 'trunk_link','primary_link','secondary','secondary_link','road','tertiary','tertiary_link')" key="{bfc87443-ef95-44b0-a66e-2cd133df0ce1}" symbol="5" label="roads"/>
      <rule scalemaxdenom="1000" key="{9e457b64-d594-4ba2-806c-b4dacdfc576c}" symbol="6" scalemindenom="1" label="minor roads"/>
      <rule scalemaxdenom="125000" key="{c070882a-19ad-423d-a6c7-322ef8da0219}" symbol="7" scalemindenom="1000" label="minor roads"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.235294" type="line" name="2">
        <layer pass="3" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0"/>
      ...
      <symbol alpha="0.247059" type="line" name="4">
        <layer pass="2" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0"/>
