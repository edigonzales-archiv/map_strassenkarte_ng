...
<qgis version="2.7.0-Master" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{c77e8bb6-ad46-40da-be4e-9245cb5c4334}">
      <rule scalemaxdenom="25000" key="{5b0519f8-7a64-4fcb-a61c-1e5050bcc13c}" symbol="0" scalemindenom="1"/>
      <rule scalemaxdenom="100000" key="{d15e3170-af55-4280-93ab-0d5723d2c878}" symbol="1" scalemindenom="25000"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.698039" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0"/>
